...
//
//    @Test
//    void struct0() throws FileNotFoundException{
//        Scanner sc = new Scanner(new File("tests/struct0.c"));
//        Tokeniser tk = new Tokeniser(sc);
//
//        //#include "stdlib.h"
//        assert tk.nextToken().tokenClass == Token.TokenClass.INCLUDE;
...
//
//        //struct point
//        assert tk.nextToken().tokenClass == Token.TokenClass.STRUCT;
//        assert tk.nextToken().tokenClass == Token.TokenClass.IDENTIFIER;
//
//        //{
//        assert tk.nextToken().tokenClass == Token.TokenClass.LBRA;
...
//        assert tk.nextToken().tokenClass == Token.TokenClass.INT;
//        assert tk.nextToken().tokenClass == Token.TokenClass.IDENTIFIER;
//        assert tk.nextToken().tokenClass == Token.TokenClass.COMMA;
//        assert tk.nextToken().tokenClass == Token.TokenClass.IDENTIFIER;
//        assert tk.nextToken().tokenClass == Token.TokenClass.SC;
//
//        //};
...
//
//    @Test
//    void struct1() throws FileNotFoundException{
//        Scanner sc = new Scanner(new File("tests/struct1.c"));
//        Tokeniser tk = new Tokeniser(sc);
//
//        //#include "stdlib.h"
//        assert tk.nextToken().tokenClass == Token.TokenClass.INCLUDE;
